...
package com.huawei.test.transformer;

import com.huawei.test.ModuleLoader;
import com.huawei.test.dependency.DependencyFinder;
import com.huawei.test.hook.AbstractClassHook;
import com.huawei.test.tool.annotation.AnnotationScanner;
...
public class CustomClassTransformer implements ClassFileTransformer {
    ...
    private static final String SCAN_ANNOTATION_PACKAGE = "com.huawei.test.hook";
