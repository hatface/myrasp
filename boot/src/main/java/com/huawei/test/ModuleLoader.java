        ...
        if (null == pkgs || !pkgs.contains("baidu.openrasp")) {
            if (pkgs != null && !pkgs.isEmpty()) {
                pkgs = System.setProperty("jboss.modules.system.pkgs",
                        pkgs + ",org.jboss.logmanager,com.huawei.test,com.sdwaf,javax.servlet,javax.el");
            } else {
                pkgs = System.setProperty("jboss.modules.system.pkgs",
                        "org.jboss.logmanager,com.huawei.test,com.sdwaf,javax.servlet,javax.el");
            }
            pkgs = System.setProperty("jboss.modules.system.pkgs", pkgs + ",org.jboss.logmanager,com.huawei.test,com.sdwaf,javax.servlet,javax.el");
